export default {
  ...
  'menu.bargaingroupon.groupon-product-list': '团购商品列表',
  'menu.bargaingroupon.groupon-list': '团购列表',
  'menu.bargaingroupon.seckill-product-list': '秒杀商品列表',
  'menu.bargaingroupon.seckill-list': '秒杀列表',
  'menu.coupon': '优惠卷',
